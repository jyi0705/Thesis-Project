...
class ApprovalPage extends Component {
  ...
  render(){
    return(
      <div id="approval" className="container">
        <section id="content">
          <form action="">
            <h1>Get Verified</h1>
            <div>
              <input name="walletId" type="text" placeholder="Enter Ethereum Wallet" required="" onChange={this.handleInputChange}/>
            </div>
            <div>
              <input name="email" type="email" placeholder="Enter Email" required="" onChange={this.handleInputChange}/>
            </div>
            <div>
              <input name="startAge" type="number" placeholder="Enter Age" required="" onChange={this.handleInputChange}/>
            </div>
            <div>
      ...
      //       No
      //     </label>
      //     <button className="submit-btn bounceOut" >Submit</button>
      //   </form>
      //   <div
